...
if not __name__ == "__main__":
    a = GreatVotingSystem(5, 9, 10, 2, ["", "2", "3", "4", "5", "6", "7", "8", "9"])
    a._makePotentialVoter("1111-111111", "test_voiter1")
    a._makePotentialVoter("1111-111112", "test_voiter2")
    a.startVoting()
    print('voter login', a._voterLogin("1111-111111", "aaaaaa"))
    print('potential voter login', a._potentialVoterLogin("1111-111111", "aaaaaa"))
    aboba=a._voterLogin("1111-111111", "aaaaaa")
    aboba2=a._voterLogin("1111-111112", "aaaaaaa")
    a.vote(aboba.user_id,aboba.public_key,"3")
    a.vote(aboba.user_id,aboba.public_key,"2")
    a.vote(aboba2.user_id,aboba2.public_key,"5")
    print("here")
    print(a.countVotes())
...
def election_results():
    ...
    return render_template_string(election_results_tpl, results=results)
...
# Define HTML template for errors
error_html_template = """
<!DOCTYPE html>
<html lang="en">
<head>
...
def internal_server_error(error):
    error_title = 'You\'re doing something in the wrong order, stop it.'
    error_message = 'Well, you did something wrong. Shame on you!'
    return error_html_template.format(error_code='', error_title=error_title, error_message=error_message), 200
